...
public class StreamDemo
{
	public static void main(String[] args)
	{
		...
		// Obtain the maximum using max(), min(), isPresent(), get()
		...
		// Display the stream by use of forEach()
		...
		Stream<Integer> oddGreaterThanFiveVals = myList.stream().filter((n) -> (n % 2) == 1).filter((n) -> (n > 5));
		System.out.print("Odd values greater than 5 : ");
		oddGreaterThanFiveVals.forEach((n) -> System.out.print(n + " ")); 
	}
}
